...
public class DayTimetableFragment extends ListFragment {
    public static final String ARG_NUM = "ARG_NUM";
    private static final String TAG = "DayTimetableFragment";
    ...
    public static DayTimetableFragment newInstance(int num) {
